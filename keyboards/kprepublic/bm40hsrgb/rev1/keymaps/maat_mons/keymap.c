...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [_NUMBERS] = LAYOUT_planck_mit(
      KC_BSPC, XXXXXXX, KC_1, KC_2, KC_3, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, _______,
      ...
      KC_ENT, _______, XXXXXXX, KC_0, _______, _______, MO(_FUNCTION), XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX
      ),
