...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [_SPECIAL] = LAYOUT_planck_mit(
      _______, KC_TILD, KC_EXLM, KC_AT,   KC_HASH, XXXXXXX, XXXXXXX, KC_LPRN, KC_RPRN, KC_LCBR, KC_RCBR, KC_PLUS,
      _______, XXXXXXX, KC_DLR,  KC_PERC, KC_CIRC, XXXXXXX, XXXXXXX, KC_LBRC, KC_RBRC, KC_QUOT, KC_DQUO, KC_MINS,
      _______, XXXXXXX, KC_AMPR, KC_ASTR, KC_GRV,  XXXXXXX, XXXXXXX, KC_SCLN, KC_COLN, KC_UNDS, KC_EQL, KC_INS,
      _______, _______, _______, XXXXXXX, MO(_FUNCTION), _______, _______, KC_HOME, KC_PGDN, KC_PGUP, KC_END
      ),

    [_NUMBERS] = LAYOUT_planck_mit(
      XXXXXXX, XXXXXXX, KC_1, KC_2, KC_3, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, KC_DEL,
      _______, XXXXXXX, KC_4, KC_5, KC_6, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, KC_PSCR,
      _______, XXXXXXX, KC_7, KC_7, KC_8, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, _______,
