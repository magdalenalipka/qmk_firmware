...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [_NUMBERS] = LAYOUT_planck_mit(
        ...
        _______, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX,       XXXXXXX, XXXXXXX, XXXXXXX, KC_7,    KC_8, KC_9,    XXXXXXX,
        _______, _______, XXXXXXX, _______, MO(_FUNCTION),     _______,      _______, XXXXXXX, KC_0, XXXXXXX, XXXXXXX
    ),
    
    [_FUNCTION] = LAYOUT_planck_mit(
        RESET,   XXXXXXX, RGB_MOD, RGB_HUD, RGB_HUI, KC_BRID,    KC_BRIU, XXXXXXX, KC_F1,   KC_F2,  KC_F3,  XXXXXXX,
        DEBUG,   BL_TOGG, BL_STEP, RGB_VAD, RGB_VAI, KC_VOLD,    KC_VOLU, XXXXXXX, KC_F4,   KC_F5,  KC_F6,  XXXXXXX,
        XXXXXXX, BL_DEC,  BL_INC,  RGB_SAD, RGB_SAI, XXXXXXX,    XXXXXXX, XXXXXXX, KC_F7,   KC_F8,  KC_F9,  XXXXXXX,
